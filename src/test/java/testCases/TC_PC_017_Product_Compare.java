...
public class TC_PC_017_Product_Compare extends BaseClass {
	@Test(groups = { "Sanity", "Master" })
	public void validateTC_PC_017() {

		logger.info("---------TC_PC_017----Started----------");
		...
		logger.info("---------TC_PC_017----Finished----------");
